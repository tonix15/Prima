<?php
$page_name = 'Buildings with Rate Utility Mismatch';
...
$data_list = $dbhandler->valBuildingsRateAccountUtilityNotMatching($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Buildings with Rate Utility Mismatch Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<table class="billing scrollable planning-table planning-table-striped planning-table-hover">
				<thead>
					<tr>
						...
						<th>Building Name</th>
						<th>Building Rate Account Utility Type</th>
						<th>Account Number</th>
						<th>Rate Number</th>
						<th>Rate Name</th>
						<th>Rate Utility Type</th>
					</tr>
				</thead>
				<tbody>
					<?php 
					...
					?>
							<tr>
								...
								<td><?php echo $report['BuildingRateAccountUtilityType']; ?></td>
								<td><?php echo $report['AccountNumber']; ?></td>
								<td><?php echo $report['RateNumber']; ?></td>
								<td><?php echo $report['RateName']; ?></td>
								<td><?php echo $report['RateUtilityType']; ?></td>
							</tr>
					<?php endforeach; 
			...
			<?php
				...
				$title = 'Buildings with Rate Utility Mismatch Report';
