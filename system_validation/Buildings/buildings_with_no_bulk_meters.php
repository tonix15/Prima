<?php
$page_name = 'Buildings with no Bulk Meters';
...
$data_list = $dbhandler->valBuildingsNoBulkMeters($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Buildings with no Bulk Meters Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			<?php 
				...
				ob_start(); 
			?>
			<table class="billing scrollable planning-table planning-table-striped planning-table-hover" style="width:40%;">
				<thead>
					<tr>
			...
			<?php
				...
				$title = 'Buildings with no Bulk Meters Report';
