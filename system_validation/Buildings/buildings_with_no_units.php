<?php
$page_name = 'Buildings with no Units';
...
$data_list = $dbhandler->valBuildingsNoUnits($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Buildings with no Units Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<?php
				...
				$title = 'Buildings with no Units Report';
