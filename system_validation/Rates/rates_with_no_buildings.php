<?php
$page_name = 'Rates with no Buildings';
...
$data_list = $dbhandler->valRatesNoBuildings($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Rates with no Buildings Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<table class="billing scrollable planning-table planning-table-striped planning-table-hover">
				<thead>
					<tr>
						...
						<th>Provider Name</th>
						<th>Is Internal Provider</th>
						<th>Rate Number</th>
						<th>Rate Name</th>						
						<th>Utility Type</th>
						<th>Billing Description</th>
						<th>Is Rate VAT Applicable</th>
					</tr>
				</thead>
				<tbody>
					<?php 
					...
					?>
							<tr>
								<td><?php echo $report['ProviderNumber']; ?></td>								
								<td><?php echo $report['ProviderName']; ?></td>
								<td class="table-column-text-align-center"><?php echo $report['IsInternalProvider']; ?></td>
								<td><?php echo $report['RateNumber']; ?></td>
								<td><?php echo $report['RateName']; ?></td>
								<td><?php echo $report['UtilityType']; ?></td>
								<td><?php echo $report['BillingDescription']; ?></td>
								<td class="table-column-text-align-center"><?php echo $report['IsRateVATApplicable']; ?></td>
							</tr>
					<?php endforeach; 
			...
			<?php
				...
				$title = 'Rates with no Buildings Report';
