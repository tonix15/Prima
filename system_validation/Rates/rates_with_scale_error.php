<?php
$page_name = 'Rates with Scale Error';
...
$data_list = $dbhandler->valRatesScaleError($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Rates with Scale Error Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<?php
				...
				$title = 'Rates with Scale Error Report';
