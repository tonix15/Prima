<?php
$page_name = 'Rates with no Provider';
...
$data_list = $dbhandler->valRatesNoProvider($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Rates with no Provider Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
				...
				<tbody>
					...
					?>
							<tr>
								...
								<td><?php echo $report['IsRateVATApplicable']; ?></td>																
							</tr>
					<?php endforeach; 
			...
			<?php
				...
				$title = 'Rates with no Provider Report';
