<?php
$page_name = 'Rates with no Retail or Bulk Rate';
...
$data_list = $dbhandler->valRatesNoBulkorRetail($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Rates with no Retail or Bulk Rate Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
				...
				<tbody>
					...
					?>
							<tr>
								...
								<td><?php echo $report['MissingRateType']; ?></td>
							</tr>
					<?php endforeach; 
			...
			<?php
				...
				$title = 'Rates with no Retail or Bulk Rate Report';
