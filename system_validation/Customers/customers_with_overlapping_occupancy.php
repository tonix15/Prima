<?php
$page_name = 'Customers with Overlapping Occupancy';
...
$data_list = $dbhandler->getCustomerOverlappingOccupancy($params);
	...
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<?php
				...
				$title = 'Customers with Overlapping Occupancy Report';
