<?php
$page_name = 'Prepaid Customers with Overlapping Occupancy';
...
<div class="sub-menu-title"><h1>Prepaid Customers with Overlapping Occupancy Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<?php
				...
				$title = 'Prepaid Customers with Overlapping Occupancy Report';
