<?php
$page_name = 'Decommissioned not Replaced';
...
$data_list = $dbhandler->valMeterDecommissionedWithoutReplacement($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Decommissioned not Replaced Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<?php
				...
				$title = 'Decommissioned not Replaced Report';
