...
$data_list = $dbhandler->valMeterDecommissionedIsActive($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Decommissioned and IsActive Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
				...
				<tbody>
					...
					?>
							<tr>
								...
								<td class="table-column-text-align-center"><?php echo $report['IsActive']; ?></td>																
							</tr>
					<?php endforeach; 
			...
			<?php
				...
				$title = 'Decommissioned and IsActive Report';
