<?php
$page_name = 'Duplicate Meter Number';
...
$data_list = $dbhandler->valMetersDuplicate($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Duplicate Meter Number Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<?php
				...
				$title = 'Duplicate Meter Number Report';
