<?php
$page_name = 'Meter Utility Type Unknown';
...
$data_list = $dbhandler->valMeterUtilityTypeUnknown($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Meter Utility Type Unknown Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
				...
				<tbody>
					...
					?>
							<tr>
								...
								<td class="table-column-text-align-center"><?php echo $report['MeterNumber']; ?></td>
								<td><?php echo $report['MeterType']; ?></td>
							</tr>
					<?php endforeach; 
			...
			<?php
				...
				$title = 'Meter Utility Type Unknown Report';
