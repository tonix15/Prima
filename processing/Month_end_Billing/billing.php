	...
	<form method="post">		
		...
		<div class="wrapper-panel">	
			...
			<?php
				...
				$title = 'Billing for  ' . ucwords(strtolower($building_names['Name'])) . ' ' . $building_billing_date;
				$Session->write('title', $title);
				$Session->write('content', $html);
			?>
			<label>
				Export as: <a href="<?php echo DOMAIN_NAME . '/processing/exportAsPdf.php';?>">PDF</a>
				<a href="<?php echo DOMAIN_NAME . '/processing/exportAsCSV.php';?>">SpreadSheet</a>
			</label>
