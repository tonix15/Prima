<?php
$page_name = 'Reading Variance Parameter Analysis';
...
<div class="sub-menu-title"><h1>Reading Variance Parameter Analysis Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<?php
				...
				$title = 'Reading Variance Parameter Analysis Report';
