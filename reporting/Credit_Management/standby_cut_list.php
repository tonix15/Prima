...
if (isset($_GET['View'])) { 	    
	...
	$data_list = $dbhandler->repStandbyCutList($params);
...
<div class="sub-menu-title"><h1>Standby Cut List Report</h1></div>
<form method="get">
					...
					<tbody>
						<?php foreach($data_list as $report):?>
							<tr>
								...
								<td><?php echo $report['UnitNumber']; ?></td>
								<td><?php echo $report['Surname']; ?></td>
								<td><?php echo $report['Cellphone']; ?></td>
								<td class="table-column-text-align-right"><?php echo $report['OutstandingAmount']; ?></td>								
								<td><?php echo $report['CutBy'];; ?></td>
							</tr>
						<?php endforeach; ?>
					</tbody>
				</table>
