...
<div class="sub-menu-title"><h1>Total Square Meters for Buildings with SQM Allocation Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<?php
				...
				$title = 'Total Square Meters for Buildings with SQM Allocation Report';
