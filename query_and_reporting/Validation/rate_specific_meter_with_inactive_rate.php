...
$data_list = $dbhandler->getMeterInActiveRate($params);
$errmsg = !empty($data_list) ? '':'<strong>No Entries Found.</strong>';	
?>

<div class="sub-menu-title"><h1>Rate Specific Meter with Inactive Rate Report</h1></div>
	<div class="table-wrapper billing-data-list-container">
		...
		<div class="wrapper-panel">	
			...
			<?php
				...
				$title = 'Rate Specific Meter with Inactive Rate Report';
