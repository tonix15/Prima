<?php
$page_name = 'Estimated Readings Report';
...
if (isset($_GET['View'])) { 	    
	...
	$data_list = $dbhandler->repReadingEstimated($params);
...
<div class="sub-menu-title"><h1>Estimated Readings Report</h1></div>
<form method="get">
<div id="rate-selection" class="wrapper-fieldset-forms hover-cursor-pointer">
    <fieldset class="fieldset-forms">
        <legend>Estimated Readings</legend>
        <ul class="fieldset-forms-li-2-cols">            
            <li>Reading Date:</li>
            <li><input type="date" id="estimated-reading-selection-date" name="choose_date" class="selection-required-input" value="<?php echo $selectedDate; ?>"/></li>	
        </ul>
		...
		<div class="table-wrapper billing-data-list-container">
			...
			<div class="wrapper-panel">
				...
				<?php
					...
					$title = 'Estimated Readings Report as of ' . $selectedDate;
